...
class CharacterController:
    ...
    def dump_character(self):
        temp_char_dir = Path("/Users/macbook/Imp/fu_charsheet/fu_charsheet/characters").resolve(strict=True)
    ...
    def dump_avatar(self, image: UploadedFile):
        temp_char_img_dir = Path("/Users/macbook/Imp/fu_charsheet/fu_charsheet/characters/character_images").resolve(strict=True)
